# -*- coding: utf-8 -*-
#
# steampak documentation build configuration file.
#
...
project = u'steampak'
copyright = u'2015-2016, Igor `idle sign` Starikov'
...
latex_documents = [
  ('index', 'steampak.tex', u'steampak Documentation',
...
man_pages = [
    ('index', 'steampak', u'steampak Documentation',
